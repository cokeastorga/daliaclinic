  ...
  const SymbolSvg = ({ sizePx = 44 }: { sizePx?: number }) => (
    ...
    >
      <defs>
        ...
        <linearGradient id="petalNavy" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#1C4E72" />
          <stop offset="100%" stopColor="#133853" />
        </linearGradient>
      </defs>
      ...
      {/* Center Tooth Silhouette Encapsulated within the Dalia Bloom */}
      <path
    ...
    return (
      <Link href="/" className={`inline-flex flex-col items-center text-center group ${className}`}>
        ...
        <div className="mt-2.5 flex flex-col items-center">
          <span
            className={`font-serif tracking-[0.22em] text-2xl md:text-3xl font-semibold uppercase leading-none transition-colors ${
          ...
          <div className="flex items-center gap-2 my-1 w-full justify-center">
            <div className={`h-[1px] w-6 ${isDark ? "bg-dalia-gold/50" : "bg-dalia-gold"}`} />
            <span
              className={`font-sans tracking-[0.35em] text-[10px] uppercase font-medium ${
          ...
          <span
            className={`font-sans tracking-[0.16em] text-[9px] uppercase font-semibold mt-0.5 ${
    ...
    <Link href="/" className={`inline-flex items-center gap-3.5 group ${className}`}>
      ...
      <div className="flex flex-col justify-center">
        <div className="flex items-baseline gap-2">
          <span
            className={`font-serif tracking-[0.18em] text-xl md:text-2xl font-bold uppercase leading-none transition-colors ${
              isDark ? "text-white group-hover:text-dalia-gold" : "text-dalia-navy group-hover:text-dalia-navy-light"
            }`}
          >
            DALIA
          ...
          <span
            className={`font-sans tracking-[0.3em] text-[11px] uppercase font-semibold ${
              isDark ? "text-dalia-gold" : "text-dalia-gold-dark"
            }`}
          >
            CLINIC
        ...
        <div className="flex items-center gap-1.5 mt-1">
          <div className={`h-[1px] w-3 ${isDark ? "bg-dalia-gold/60" : "bg-dalia-gold"}`} />
          <span
            className={`font-sans tracking-[0.12em] text-[8px] md:text-[9px] uppercase font-semibold whitespace-nowrap ${
              isDark ? "text-dalia-slate-light" : "text-dalia-graphite"
            }`}
          >
            Odontología Integral y Armonización Facial
